...
public class MentalHealthResources extends NavDrawer implements  RecyclerItemClickListener.OnClickListener
{
    ...
    private void CreateMenuItems()
    {
        ...
        String[] mentalHealthTitles = getResources().getStringArray(R.array.mental_health_menu_titles);

        for(String title : mentalHealthTitles)
        {
            MenuItem item = new MenuItem(title, R.drawable.enquiry_menu_icon, false);
            buttons.add(item);
        }
    ...
    {
        Intent intent = new Intent(MentalHealthResources.this, ContentActivity.class);
